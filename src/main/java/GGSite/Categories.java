...
public class Categories {
    ...
    public static void main(String[] args) {
        ...
        driver.get("https://sites.google.com/site/foryacoupon/categories");
        ...
        for (int i = 0; i < btn.size(); i++) {
            ...
            System.out.println("Nhóm "+ textCat + " có: " + cat.size() + " categories");
            ...
            for (int j = 0; j < cat.size(); j++) {
                ...
                driver.get("https://sites.google.com/site/foryacoupon/categories#" + textCat);
